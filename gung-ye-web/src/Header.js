    ...
    return <header className={style.Header}>
        <div className={style.header}>
            <div className={style.left}>
                <div className={`${style.btn} ${style.naviBtn}`} onClick={menuChange} >
            ...
            <div className={style.right}>
                ...
                <div className={`${style.btn} ${style.myWorkBtn}`} onClick={changeToMyWork}>
                    <ion-icon name="reader"></ion-icon>
                </div>
                <div className={`${style.btn} ${style.profileBtn}`} onClick={changeToMyProfile}>
